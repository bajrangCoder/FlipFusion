...
<svelte:head>
	<title>FlipFusion Game</title>
	<meta name="description" content="A fun and challenging matching card game" />
	<meta
		name="keywords"
		content="matching game, card game, memory game, emoji game, svelte game, online game"
	/>
